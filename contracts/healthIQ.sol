...
contract healthIQ {
    ...
    struct account {
        //account for doctor and patient
        string name;
        uint contact;
        string id;
        string password;
    ...
    function patientSignUp(
        ...
        account memory new_patient = account(
            _name,
            _contact,
            _id,
            _password,
    ...
    function doctorSignUp(
        ...
        account memory new_doctor = account(
            _name,
            _contact,
            _id,
            _password,
    ...
    function doctorSubmitDetails(
        ...
        DoctorLog memory new_doctorlog = DoctorLog(
            _id,
            _age,
            _weight,
            _height,
    ...
    function doctorViewDetails(
        ...
        view
        returns (
            DoctorLog[] memory //for doctor to check patient's details history
        )
    {
        require(is_patient_registered[_id] == true);
        return doc_log[_id];
